        ...
        <main id='main' class='site-main'>
          ...
          >
            ...
            <div class='entry-content' itemprop='text'>
              ...
              <p>You must not:</p>
              <ul>
                <li>Republish material from Udyamit</li>
                <li>Sell, rent or sub-license material from Udyamit</li>
                <li>Reproduce, duplicate or copy material from Udyamit</li>
                <li>Redistribute content from Udyamit</li>
              </ul>
              <p>
