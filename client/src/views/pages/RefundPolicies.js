        ...
        <main id="main" class="site-main">
          ...
          >
            ...
            <div class="entry-content" itemprop="text">
              ...
              <p>Thank you for shopping at Navachar Udyamita Vikash Council.</p>
              <p>
              ...
              <ul>
                <li>
                  <p>By email: support@nuvc.org</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website:{" "}
                    <a
                      href="https://nuvc.org/contact-us"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://nuvc.org/contact-us
                    </a>
                  </p>
                </li>
                <li>
                  <p>By phone number: 8700913366</p>
                </li>
              </ul>
              <p>
